...
var actor_schema_1 = require("./validations/actor.schema");
var actor_controller_1 = require("./controllers/actor.controller");
...
exports.routes.route('/movies/:id')
    ...
    .put((0, validation_middleware_1.ValidationMiddleware)(movie_schema_1.MovieWithActorsSchema), movie_controller_1.MovieController.updateMovie);
exports.routes.route('/actors')
    .post((0, validation_middleware_1.ValidationMiddleware)(actor_schema_1.ActorSchema), actor_controller_1.ActorController.addActor);
